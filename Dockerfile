...
RUN pip install --no-cache-dir scipy==1.5.2 dask numba bokeh scikit-learn==0.23.2

RUN apt-get install -y --no-install-recommends libgomp1 libaio-dev libaio1 tzdata
